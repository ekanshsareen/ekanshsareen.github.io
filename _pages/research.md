...
## Inter-brain synchronization in real and virtual world using EEG hyperscanning 
...
The modern day HCI applications are moving towards virtual reality (VR). It provides an immersive medium to interact with the digital world. Traditional interaction methods in VR interfaces require physical interaction through hand-held controllers. However, to offer more immersive experience to users free from all those complicated controllers researchers are now exploring hands-free engagement in VR environment through Brain Computer Interaction (BCI). These new hands-free BCI applications are largely evaluated in terms of usalibility and seldom in terms of neurological and physiological effects related to it. In this work, we investigate facial expressions as a hands-free BCI-based interaction medium and explore its neurophysiological effects in terms of cognitve load on the user. First of a kind study that highlights the neurophysiological states of the users while interacting with novel methods under VR environment.  

## Music perception: A neuroimaging based investigation of preference, relaxation, and enjoyment
Ever wondered why we enjoy listening to music of our choice much more than what is suggested by others? or How does our brain actuates a behavioural response when we listen to relaxing or exciting music? These are the some of the quetions that we are currently exploring under an exciting new neuroimaging-behavioral study.
